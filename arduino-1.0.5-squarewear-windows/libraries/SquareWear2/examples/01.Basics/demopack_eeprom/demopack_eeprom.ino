...
//  RGB LEDs).
//
// This is a demo pack that
// includes 6 different demos:
// 1. blinking all pins
// 2. blinking rgb led
// 3. fading led (using SoftPWM)
// 4. buzzer
// 5. WS2812 LED strip / matrix
// 6. buzzer on light sensor (musicbox)
// 
// Click the pushbutton to cycle
// through all demo programs.
//
// NOTE: this demo also makes use of
// the internal EEPROM to store the
// demo index, so that the next time
// you turn on SquareWear it remembers
// which demo is was running last time.
//
// *******************************
...
#define pinBlue   13
#define pinBuzzer 9
#define pinStrip  10  // assume LED strip / matrix connected to pin D10
